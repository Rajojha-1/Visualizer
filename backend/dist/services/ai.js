...
const client = hasKey ? new OpenAI({ apiKey: process.env.OPENAI_API_KEY }) : {};
export async function getAiResponse(body) {
    if (!hasKey) {
        return {
            version: '1.0',
            steps: [
    ...
    try {
        ...
        return { version: '1.0', steps: [], finalState: { variables: {}, stack: [], heap: [], stdout: [], errors: ['Invalid JSON from model'] } };
    }
}
